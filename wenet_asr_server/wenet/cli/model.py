...
class Model:
    ...
    def compute_feats(self, audio_file: Union[str, tuple[torch.Tensor, int]]) -> torch.Tensor:
        if type(audio_file) is tuple:
    ...
    @torch.no_grad()
    def _decode(self,
                audio_file: Union[str, tuple[torch.Tensor, int]],
    ...
    def transcribe(self, audio_file: Union[str, tuple[torch.Tensor, int]], tokens_info: bool = False) -> dict:
